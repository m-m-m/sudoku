...
/**
 * Implementation of {@link ChangeEvent} for {@link Field#excludeCandidate(int)}.
 *
 * @param field the {@link Field} that was modified.
 * @param candidate the {@link Field#excludeCandidate(int) excluded candidate}.
 * @param next the next {@link ChangeEvent} or {@code null} if this is the last {@link ChangeEvent} of a
 *        {@link ChangeSet}.
 */
public record ChangeEventExcludeCandidate(Field field, int candidate, ChangeEvent next) implements ChangeEvent {
