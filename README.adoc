...
* https://ct.de/yabc[Sudokus bewerten per Python-Skript] (ct' Magazin, Heise Medien)
* https://github.com/t-dillon/tdoku[tdoku] (t-dillon) C++
* https://github.com/tejasmorkar/sudoku-solver[sudoku-solver] (tejasmorkar) Python
* https://github.com/plastovicka/ColorSudoku[ColorSudoku] (plastovicka) C++
* https://pyimagesearch.com/2020/08/10/opencv-sudoku-solver-and-ocr/[OpenCV Sudoku Solver and OCR]
* https://github.com/BenJeau/JavaFX-Sudoku[JavaFX-Sudoku] (BenJeau) Java
* https://github.com/ksokolovic/JSudoku[JSudoku] (ksokolovic) Java
* https://github.com/oscr/JSudoku[JSudoku] (oscr) Java
